...
namespace DX12 {
    ...
    inline D3D12_CPU_DESCRIPTOR_HANDLE my_texture_srv_cpu_handle1;
    inline D3D12_GPU_DESCRIPTOR_HANDLE my_texture_srv_gpu_handle1;
    ...
    inline ID3D12Resource* my_texture1 = NULL;
