...
struct DoorBlocker_ActiveSkill_BP_C_ExecuteUbergraph_DoorBlocker_ActiveSkill_BP final
{
public:
...
static_assert(alignof(DoorBlocker_ActiveSkill_BP_C_ExecuteUbergraph_DoorBlocker_ActiveSkill_BP) == 0x000008, "Wrong alignment on DoorBlocker_ActiveSkill_BP_C_ExecuteUbergraph_DoorBlocker_ActiveSkill_BP");
...
static_assert(offsetof(DoorBlocker_ActiveSkill_BP_C_ExecuteUbergraph_DoorBlocker_ActiveSkill_BP, CallFunc_IsDedicatedServer_ReturnValue) == 0x000004, "Member 'DoorBlocker_ActiveSkill_BP_C_ExecuteUbergraph_DoorBlocker_ActiveSkill_BP::CallFunc_IsDedicatedServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(DoorBlocker_ActiveSkill_BP_C_ExecuteUbergraph_DoorBlocker_ActiveSkill_BP, CallFunc_IsValid_ReturnValue) == 0x000005, "Member 'DoorBlocker_ActiveSkill_BP_C_ExecuteUbergraph_DoorBlocker_ActiveSkill_BP::CallFunc_IsValid_ReturnValue' has a wrong offset!");
