...
void UCustomizationColorPalette_C::OnRemovedFromFocusPath(const struct FFocusEvent& InFocusEvent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CustomizationColorPalette_C", "OnRemovedFromFocusPath");

	Params::CustomizationColorPalette_C_OnRemovedFromFocusPath Parms{};
...
void UCustomizationColorPalette_C::OnAddedToFocusPath(const struct FFocusEvent& InFocusEvent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CustomizationColorPalette_C", "OnAddedToFocusPath");

	Params::CustomizationColorPalette_C_OnAddedToFocusPath Parms{};
