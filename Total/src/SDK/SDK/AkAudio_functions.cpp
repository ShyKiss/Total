...
int32 UAkComponent::PostAkEvent(class UAkAudioEvent* AkEvent, int32 CallbackMask, const TDelegate<void(EAkCallbackType CallbackType, class UAkCallbackInfo* CallbackInfo)>& PostEventCallback, const TArray<struct FAkExternalSourceInfo>& ExternalSources, const class FString& In_EventName)
{
	static class UFunction* Func = nullptr;
...
void UAkComponent::SetUseSpatialAudio(const bool bNewValue)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AkComponent", "SetUseSpatialAudio");
...
void UAkGameplayStatics::GetRTPCValue(class FName RTPC, int32 PlayingId, ERTPCValueType InputValueType, float* Value, ERTPCValueType* OutputValueType, class AActor* Actor)
{
	static class UFunction* Func = nullptr;
...
int32 UAkGameplayStatics::PostEvent(class UAkAudioEvent* AkEvent, class AActor* Actor, int32 CallbackMask, const TDelegate<void(EAkCallbackType CallbackType, class UAkCallbackInfo* CallbackInfo)>& PostEventCallback, class UObject* WorldContextObject, bool bStopWhenAttachedToDestroyed, const class FString& EventName)
{
	static class UFunction* Func = nullptr;
...
int32 UAkGameplayStatics::PostEventGlobal(class UAkAudioEvent* AkEvent, int32 CallbackMask, const TDelegate<void(EAkCallbackType CallbackType, class UAkCallbackInfo* CallbackInfo)>& PostEventCallback, const class FString& EventName)
{
	static class UFunction* Func = nullptr;
...
int32 UAkGameplayStatics::PostEventOnActor(class UAkAudioEvent* AkEvent, class UObject* Actor, int32 CallbackMask, const TDelegate<void(EAkCallbackType CallbackType, class UAkCallbackInfo* CallbackInfo)>& PostEventCallback, bool bStopWhenAttachedToDestroyed, const class FString& EventName)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AkGameplayStatics", "PostEventOnActor");

	Params::AkGameplayStatics_PostEventOnActor Parms{};
...
int32 UAkGameplayStatics::PostNotifyOnActor(class UAkAudioEvent* AkEvent, class AActor* Actor, int32 CallbackMask, const TDelegate<void(EAkCallbackType CallbackType, class UAkCallbackInfo* CallbackInfo)>& PostEventCallback, bool bStopWhenAttachedToDestroyed, const class FString& EventName)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AkGameplayStatics", "PostNotifyOnActor");

	Params::AkGameplayStatics_PostNotifyOnActor Parms{};
