...
public:
	...
	int32                                         CallFunc_PostEventGlobal_ReturnValue_1;            // 0x0054(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_PostEventOnActor_ReturnValue;             // 0x0068(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class ARBPickup* OldItem, class ARBPickup* NewItem)> K2Node_CreateDelegate_OutputDelegate;              // 0x00B4(0x0010)(ZeroConstructor, NoDestructor)
	bool                                          CallFunc_IsDedicatedServer_ReturnValue_1;          // 0x00C4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_C5[0x3];                                       // 0x00C5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(EAkCallbackType CallbackType, class UAkCallbackInfo* CallbackInfo)> Temp_delegate_Variable_4;                          // 0x00C8(0x0010)(ConstParm, ZeroConstructor, NoDestructor)
	bool                                          CallFunc_IsDedicatedServer_ReturnValue_2;          // 0x00D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_D9[0x7];                                       // 0x00D9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FAkExternalSourceInfo>          Temp_struct_Variable_1;                            // 0x00E0(0x0010)(ConstParm, ReferenceParm)
	...
	TDelegate<void(EAkCallbackType CallbackType, class UAkCallbackInfo* CallbackInfo)> Temp_delegate_Variable_5;                          // 0x00FC(0x0010)(ConstParm, ZeroConstructor, NoDestructor)
	bool                                          CallFunc_HasAuthority_ReturnValue;                 // 0x010C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_HasAuthority_ReturnValue_1;               // 0x010D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsLocallyControlled_ReturnValue;          // 0x010E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_10F[0x1];                                      // 0x010F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDamageInfo                            K2Node_Event_info;                                 // 0x0110(0x0050)(ConstParm, NoDestructor)
	bool                                          K2Node_ComponentBoundEvent_bOn;                    // 0x0160(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	ENVState                                      CallFunc_GetCurrentState_ReturnValue;              // 0x0161(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_ByteByte_ReturnValue;          // 0x0162(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	EEndPlayReason                                K2Node_Event_EndPlayReason;                        // 0x0163(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UAkAudioEvent*                          K2Node_CustomEvent_AkEvent;                        // 0x0170(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_PostEventGlobal_ReturnValue_2;            // 0x0178(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Temp_bool_Variable_1;                              // 0x017C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	EItemType                                     K2Node_Event_batteryType;                          // 0x017D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FFootstepData                          K2Node_Event_footstepData;                         // 0x0188(0x0038)(ConstParm, NoDestructor)
	TDelegate<void(class UObject* Loaded)>        K2Node_CreateDelegate_OutputDelegate_1;            // 0x01C0(0x0010)(ZeroConstructor, NoDestructor)
	bool                                          CallFunc_IsLocallyControlledOrSpectated_ReturnValue; // 0x01D0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsLocallyControlledOrSpectated_ReturnValue_1; // 0x01D1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsDedicatedServer_ReturnValue_4;          // 0x01D2(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsDedicatedServer_ReturnValue_5;          // 0x01D3(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          CallFunc_BP_IsInFirstPerson_ReturnValue;           // 0x01EA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BP_IsInFirstPerson_ReturnValue_1;         // 0x01EB(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_Not_PreBool_ReturnValue;                  // 0x01EC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_1ED[0x3];                                      // 0x01ED(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class USkeletalMeshComponent*>         K2Node_Event_addedExtraMeshes;                     // 0x01F0(0x0010)(ConstParm, ReferenceParm, ContainsInstancedReference)
	EPlayerCustomizationSlot                      K2Node_Event_slot;                                 // 0x0200(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_BP_IsInFirstPerson_ReturnValue_2;         // 0x0201(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_Should_Hide_Customization_Slot_in_1P_ShouldHide; // 0x0202(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class ARBPickup*                              K2Node_CustomEvent_oldItem;                        // 0x0208(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ARBPickup*                              K2Node_CustomEvent_newItem;                        // 0x0210(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_Event_DeltaSeconds;                         // 0x0218(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsDedicatedServer_ReturnValue_6;          // 0x021C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsDedicatedServer_ReturnValue_7;          // 0x021D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class APPManager_BP_C*                        CallFunc_GetPPFXManager_Manager;                   // 0x0228(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          K2Node_CustomEvent_isNvActive;                     // 0x0235(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          CallFunc_IsValid_ReturnValue_5;                    // 0x0238(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_bWantsNvOn;                           // 0x0239(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	ENightVisionAnimNotifyType                    K2Node_Event_type;                                 // 0x023A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FLinearColor                           K2Node_MakeStruct_LinearColor_1;                   // 0x0244(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_CustomEvent_Enabled;                        // 0x0254(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_bIsUnderwater;                        // 0x0255(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BP_IsInFirstPerson_ReturnValue_3;         // 0x0256(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          CallFunc_IsConsideredUsingSpectraActiveSkill_ReturnValue; // 0x0298(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_299[0x7];                                      // 0x0299(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class ABP_FX_ItemConsume_Heal_C*              CallFunc_FinishSpawningActor_ReturnValue;          // 0x02A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AActor*                                 K2Node_Event_activeSkillActor;                     // 0x02B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_BP_IsInFirstPerson_ReturnValue_4;         // 0x02B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_2B9[0x7];                                      // 0x02B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             CallFunc_GetTransform_ReturnValue_1;               // 0x02C0(0x0030)(ConstParm, IsPlainOldData, NoDestructor)
	...
	class ABP_FX_ItemConsume_Respawn_C*           CallFunc_FinishSpawningActor_ReturnValue_1;        // 0x0300(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class ARBGameStateLobby*                      CallFunc_GetRBGameStateLobby_ReturnValue;          // 0x0310(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class USceneComponent*                        CallFunc_Array_Get_Item_1;                         // 0x0330(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class USkeletalMeshComponent*                 CallFunc_Array_Get_Item_2;                         // 0x0348(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_ActorHasTag_ReturnValue;                  // 0x0355(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BooleanOR_ReturnValue_1;                  // 0x0356(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BooleanAND_ReturnValue;                   // 0x0357(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsConsideredDead_ReturnValue;             // 0x0358(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsInSAS_ReturnValue;                      // 0x0359(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BooleanOR_ReturnValue_2;                  // 0x035A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_EqualEqual_ByteByte_ReturnValue_1;        // 0x035B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_K2_AttachToComponent_ReturnValue;         // 0x035C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_35D[0x3];                                      // 0x035D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         K2Node_CustomEvent_Duration_1;                     // 0x0360(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_CustomEvent_Duration;                       // 0x0364(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_CustomEvent_FullLoudnessRange;              // 0x0368(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_CustomEvent_MaxHearingDistance;             // 0x036C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         Temp_int_Loop_Counter_Variable_2;                  // 0x0370(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(bool IsNvActive)>              K2Node_CreateDelegate_OutputDelegate_2;            // 0x037C(0x0010)(ZeroConstructor, NoDestructor)
};
...
static_assert(sizeof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP) == 0x000390, "Wrong size on RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP");
...
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_object_Variable) == 0x000008, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_object_Variable' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_DynamicCast_AsSkeletal_Mesh) == 0x000010, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_DynamicCast_AsSkeletal_Mesh' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_DynamicCast_bSuccess) == 0x000018, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_bool_Variable) == 0x000019, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_object_Variable_1) == 0x000020, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_object_Variable_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_object_Variable_2) == 0x000028, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_object_Variable_2' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_delegate_Variable) == 0x000030, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_delegate_Variable' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_delegate_Variable_1) == 0x000040, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_delegate_Variable_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_PostEventGlobal_ReturnValue) == 0x000050, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_PostEventGlobal_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_PostEventGlobal_ReturnValue_1) == 0x000054, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_PostEventGlobal_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_delegate_Variable_2) == 0x000058, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_delegate_Variable_2' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_PostEventOnActor_ReturnValue) == 0x000068, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_PostEventOnActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_Lerp_ReturnValue) == 0x00006C, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_Lerp_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsDedicatedServer_ReturnValue) == 0x000070, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsDedicatedServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_MakeStruct_LinearColor) == 0x000074, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_MakeStruct_LinearColor' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_delegate_Variable_3) == 0x000084, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_delegate_Variable_3' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_struct_Variable) == 0x000098, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_struct_Variable' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_int_Loop_Counter_Variable) == 0x0000A8, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_Add_IntInt_ReturnValue) == 0x0000AC, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_int_Array_Index_Variable) == 0x0000B0, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_CreateDelegate_OutputDelegate) == 0x0000B4, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsDedicatedServer_ReturnValue_1) == 0x0000C4, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsDedicatedServer_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_delegate_Variable_4) == 0x0000C8, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_delegate_Variable_4' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsDedicatedServer_ReturnValue_2) == 0x0000D8, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsDedicatedServer_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_struct_Variable_1) == 0x0000E0, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_struct_Variable_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_CustomEvent_Loaded) == 0x0000F0, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_CustomEvent_Loaded' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsDedicatedServer_ReturnValue_3) == 0x0000F8, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsDedicatedServer_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_delegate_Variable_5) == 0x0000FC, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_delegate_Variable_5' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_HasAuthority_ReturnValue) == 0x00010C, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_HasAuthority_ReturnValue_1) == 0x00010D, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_HasAuthority_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsLocallyControlled_ReturnValue) == 0x00010E, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsLocallyControlled_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_Event_info) == 0x000110, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_Event_info' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_ComponentBoundEvent_bOn) == 0x000160, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_ComponentBoundEvent_bOn' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_GetCurrentState_ReturnValue) == 0x000161, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_GetCurrentState_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000162, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_Event_EndPlayReason) == 0x000163, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_Event_EndPlayReason' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_float_Variable) == 0x000164, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_float_Variable' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_float_Variable_1) == 0x000168, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_float_Variable_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_CustomEvent_AkEvent) == 0x000170, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_CustomEvent_AkEvent' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_PostEventGlobal_ReturnValue_2) == 0x000178, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_PostEventGlobal_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_bool_Variable_1) == 0x00017C, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_bool_Variable_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_Event_batteryType) == 0x00017D, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_Event_batteryType' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_PostAkEvent_ReturnValue) == 0x000180, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_PostAkEvent_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_Event_footstepData) == 0x000188, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_Event_footstepData' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_CreateDelegate_OutputDelegate_1) == 0x0001C0, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsLocallyControlledOrSpectated_ReturnValue) == 0x0001D0, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsLocallyControlledOrSpectated_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsLocallyControlledOrSpectated_ReturnValue_1) == 0x0001D1, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsLocallyControlledOrSpectated_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsDedicatedServer_ReturnValue_4) == 0x0001D2, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsDedicatedServer_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsDedicatedServer_ReturnValue_5) == 0x0001D3, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsDedicatedServer_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_int_Array_Index_Variable_1) == 0x0001D4, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_int_Array_Index_Variable_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_Array_Length_ReturnValue) == 0x0001D8, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_Array_Get_Item) == 0x0001E0, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsValid_ReturnValue) == 0x0001E8, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsValid_ReturnValue_1) == 0x0001E9, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_BP_IsInFirstPerson_ReturnValue) == 0x0001EA, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_BP_IsInFirstPerson_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_BP_IsInFirstPerson_ReturnValue_1) == 0x0001EB, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_BP_IsInFirstPerson_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_Not_PreBool_ReturnValue) == 0x0001EC, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_Event_addedExtraMeshes) == 0x0001F0, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_Event_addedExtraMeshes' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_Event_slot) == 0x000200, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_Event_slot' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_BP_IsInFirstPerson_ReturnValue_2) == 0x000201, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_BP_IsInFirstPerson_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_Should_Hide_Customization_Slot_in_1P_ShouldHide) == 0x000202, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_Should_Hide_Customization_Slot_in_1P_ShouldHide' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_Array_Length_ReturnValue_1) == 0x000204, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_CustomEvent_oldItem) == 0x000208, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_CustomEvent_oldItem' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_CustomEvent_newItem) == 0x000210, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_CustomEvent_newItem' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_Event_DeltaSeconds) == 0x000218, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_Event_DeltaSeconds' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsDedicatedServer_ReturnValue_6) == 0x00021C, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsDedicatedServer_ReturnValue_6' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsDedicatedServer_ReturnValue_7) == 0x00021D, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsDedicatedServer_ReturnValue_7' has a wrong offset!");
...
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_GetPPFXManager_Manager) == 0x000228, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_GetPPFXManager_Manager' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_PostAkEvent_ReturnValue_1) == 0x000230, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_PostAkEvent_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsValid_ReturnValue_2) == 0x000234, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_CustomEvent_isNvActive) == 0x000235, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_CustomEvent_isNvActive' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsValid_ReturnValue_3) == 0x000236, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsValid_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsValid_ReturnValue_4) == 0x000237, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsValid_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsValid_ReturnValue_5) == 0x000238, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsValid_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_Event_bWantsNvOn) == 0x000239, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_Event_bWantsNvOn' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_Event_type) == 0x00023A, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_Event_type' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_SwitchEnum_CmpSuccess) == 0x00023B, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_Select_Default) == 0x00023C, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_Not_PreBool_ReturnValue_1) == 0x000240, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_MakeStruct_LinearColor_1) == 0x000244, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_MakeStruct_LinearColor_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_CustomEvent_Enabled) == 0x000254, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_CustomEvent_Enabled' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_Event_bIsUnderwater) == 0x000255, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_Event_bIsUnderwater' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_BP_IsInFirstPerson_ReturnValue_3) == 0x000256, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_BP_IsInFirstPerson_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_GetTransform_ReturnValue) == 0x000260, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_GetTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue) == 0x000290, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsConsideredUsingSpectraActiveSkill_ReturnValue) == 0x000298, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsConsideredUsingSpectraActiveSkill_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_FinishSpawningActor_ReturnValue) == 0x0002A0, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_FinishSpawningActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_Select_Default_1) == 0x0002A8, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_Event_activeSkillActor) == 0x0002B0, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_Event_activeSkillActor' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_BP_IsInFirstPerson_ReturnValue_4) == 0x0002B8, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_BP_IsInFirstPerson_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_GetTransform_ReturnValue_1) == 0x0002C0, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_GetTransform_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_int_Loop_Counter_Variable_1) == 0x0002F0, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_int_Loop_Counter_Variable_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1) == 0x0002F8, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_FinishSpawningActor_ReturnValue_1) == 0x000300, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_FinishSpawningActor_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_Less_IntInt_ReturnValue) == 0x000308, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_Add_IntInt_ReturnValue_1) == 0x00030C, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_GetRBGameStateLobby_ReturnValue) == 0x000310, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_GetRBGameStateLobby_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsValid_ReturnValue_6) == 0x000318, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsValid_ReturnValue_6' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_BooleanOR_ReturnValue) == 0x000319, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_Array_Get_Item_1) == 0x000330, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_Array_Length_ReturnValue_2) == 0x000338, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_Array_Length_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_Less_IntInt_ReturnValue_1) == 0x00033C, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_int_Array_Index_Variable_2) == 0x000340, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_int_Array_Index_Variable_2' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_Array_Get_Item_2) == 0x000348, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_Array_Get_Item_2' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_Array_Add_ReturnValue) == 0x000350, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsValid_ReturnValue_7) == 0x000354, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsValid_ReturnValue_7' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_ActorHasTag_ReturnValue) == 0x000355, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_ActorHasTag_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_BooleanOR_ReturnValue_1) == 0x000356, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_BooleanOR_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_BooleanAND_ReturnValue) == 0x000357, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsConsideredDead_ReturnValue) == 0x000358, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsConsideredDead_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_IsInSAS_ReturnValue) == 0x000359, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_IsInSAS_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_BooleanOR_ReturnValue_2) == 0x00035A, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_BooleanOR_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_EqualEqual_ByteByte_ReturnValue_1) == 0x00035B, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_EqualEqual_ByteByte_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_K2_AttachToComponent_ReturnValue) == 0x00035C, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_K2_AttachToComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_CustomEvent_Duration_1) == 0x000360, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_CustomEvent_Duration_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_CustomEvent_Duration) == 0x000364, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_CustomEvent_Duration' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_CustomEvent_FullLoudnessRange) == 0x000368, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_CustomEvent_FullLoudnessRange' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_CustomEvent_MaxHearingDistance) == 0x00036C, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_CustomEvent_MaxHearingDistance' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, Temp_int_Loop_Counter_Variable_2) == 0x000370, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::Temp_int_Loop_Counter_Variable_2' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_Less_IntInt_ReturnValue_2) == 0x000374, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_Less_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, CallFunc_Add_IntInt_ReturnValue_2) == 0x000378, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::CallFunc_Add_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP, K2Node_CreateDelegate_OutputDelegate_2) == 0x00037C, "Member 'RBPlayer_BP_C_ExecuteUbergraph_RBPlayer_BP::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");

// Function RBPlayer_BP.RBPlayer_BP_C.ActivateAIDisturbanceLight_Server
// 0x000C (0x000C - 0x0000)
struct RBPlayer_BP_C_ActivateAIDisturbanceLight_Server final
{
public:
	float                                         Duration;                                          // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         FullLoudnessRange;                                 // 0x0004(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         MaxHearingDistance;                                // 0x0008(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(RBPlayer_BP_C_ActivateAIDisturbanceLight_Server) == 0x000004, "Wrong alignment on RBPlayer_BP_C_ActivateAIDisturbanceLight_Server");
static_assert(sizeof(RBPlayer_BP_C_ActivateAIDisturbanceLight_Server) == 0x00000C, "Wrong size on RBPlayer_BP_C_ActivateAIDisturbanceLight_Server");
static_assert(offsetof(RBPlayer_BP_C_ActivateAIDisturbanceLight_Server, Duration) == 0x000000, "Member 'RBPlayer_BP_C_ActivateAIDisturbanceLight_Server::Duration' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ActivateAIDisturbanceLight_Server, FullLoudnessRange) == 0x000004, "Member 'RBPlayer_BP_C_ActivateAIDisturbanceLight_Server::FullLoudnessRange' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_ActivateAIDisturbanceLight_Server, MaxHearingDistance) == 0x000008, "Member 'RBPlayer_BP_C_ActivateAIDisturbanceLight_Server::MaxHearingDistance' has a wrong offset!");

// Function RBPlayer_BP.RBPlayer_BP_C.TurnAIDisturbanceLightOff_Delayed
// 0x0004 (0x0004 - 0x0000)
struct RBPlayer_BP_C_TurnAIDisturbanceLightOff_Delayed final
{
public:
	float                                         Duration;                                          // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(RBPlayer_BP_C_TurnAIDisturbanceLightOff_Delayed) == 0x000004, "Wrong alignment on RBPlayer_BP_C_TurnAIDisturbanceLightOff_Delayed");
static_assert(sizeof(RBPlayer_BP_C_TurnAIDisturbanceLightOff_Delayed) == 0x000004, "Wrong size on RBPlayer_BP_C_TurnAIDisturbanceLightOff_Delayed");
static_assert(offsetof(RBPlayer_BP_C_TurnAIDisturbanceLightOff_Delayed, Duration) == 0x000000, "Member 'RBPlayer_BP_C_TurnAIDisturbanceLightOff_Delayed::Duration' has a wrong offset!");
...
{
public:
	struct FPlayerHitReactionParams               HitReaction;                                       // 0x0000(0x0050)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor)
	struct FVector                                AttackLoc;                                         // 0x0050(0x000C)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         HitRelativeAngle;                                  // 0x005C(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class URBFXManager*                           CallFunc_GetFXManager_ReturnValue;                 // 0x0068(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(RBPlayer_BP_C_Event_PlayHitReactionEffects) == 0x000070, "Wrong size on RBPlayer_BP_C_Event_PlayHitReactionEffects");
...
static_assert(offsetof(RBPlayer_BP_C_Event_PlayHitReactionEffects, AttackLoc) == 0x000050, "Member 'RBPlayer_BP_C_Event_PlayHitReactionEffects::AttackLoc' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_Event_PlayHitReactionEffects, HitRelativeAngle) == 0x00005C, "Member 'RBPlayer_BP_C_Event_PlayHitReactionEffects::HitRelativeAngle' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_Event_PlayHitReactionEffects, CallFunc_IsLocallyControlled_ReturnValue) == 0x000060, "Member 'RBPlayer_BP_C_Event_PlayHitReactionEffects::CallFunc_IsLocallyControlled_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_Event_PlayHitReactionEffects, K2Node_SwitchEnum_CmpSuccess) == 0x000061, "Member 'RBPlayer_BP_C_Event_PlayHitReactionEffects::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_Event_PlayHitReactionEffects, CallFunc_GetFXManager_ReturnValue) == 0x000068, "Member 'RBPlayer_BP_C_Event_PlayHitReactionEffects::CallFunc_GetFXManager_ReturnValue' has a wrong offset!");
...
public:
	...
	class USkeletalMeshComponent*                 CallFunc_CreateSkeletalMeshForShadow_Out;          // 0x0040(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(RBPlayer_BP_C_CreateShadowmeshCopyOfSkeletalMesh) == 0x000050, "Wrong size on RBPlayer_BP_C_CreateShadowmeshCopyOfSkeletalMesh");
...
static_assert(offsetof(RBPlayer_BP_C_CreateShadowmeshCopyOfSkeletalMesh, CallFunc_IsValidClass_ReturnValue) == 0x000028, "Member 'RBPlayer_BP_C_CreateShadowmeshCopyOfSkeletalMesh::CallFunc_IsValidClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_CreateShadowmeshCopyOfSkeletalMesh, K2Node_DynamicCast_AsSkeletal_Mesh_Component) == 0x000030, "Member 'RBPlayer_BP_C_CreateShadowmeshCopyOfSkeletalMesh::K2Node_DynamicCast_AsSkeletal_Mesh_Component' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_CreateShadowmeshCopyOfSkeletalMesh, K2Node_DynamicCast_bSuccess) == 0x000038, "Member 'RBPlayer_BP_C_CreateShadowmeshCopyOfSkeletalMesh::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_CreateShadowmeshCopyOfSkeletalMesh, CallFunc_Array_Add_ReturnValue) == 0x00003C, "Member 'RBPlayer_BP_C_CreateShadowmeshCopyOfSkeletalMesh::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_CreateShadowmeshCopyOfSkeletalMesh, CallFunc_CreateSkeletalMeshForShadow_Out) == 0x000040, "Member 'RBPlayer_BP_C_CreateShadowmeshCopyOfSkeletalMesh::CallFunc_CreateSkeletalMeshForShadow_Out' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_CreateShadowmeshCopyOfSkeletalMesh, CallFunc_Array_Add_ReturnValue_1) == 0x000048, "Member 'RBPlayer_BP_C_CreateShadowmeshCopyOfSkeletalMesh::CallFunc_Array_Add_ReturnValue_1' has a wrong offset!");
...
public:
	...
	struct FRBPlayerCustomizationInfo             Temp_struct_Variable;                              // 0x0010(0x0050)()
	...
	class URBPlayerCustomizationOption*           CallFunc_Array_Get_Item;                           // 0x0070(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0078(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_79[0x7];                                       // 0x0079(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class FString, class UMaterialInstanceConstant*> CallFunc_BP_GetMaterialOverrideInstancesMap_ReturnValue; // 0x0080(0x0050)()
	...
	bool                                          CallFunc_BP_IsInFirstPerson_ReturnValue;           // 0x0100(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_101[0x7];                                      // 0x0101(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TScriptInterface<class IRBPlayerCustomizationOwner> K2Node_DynamicCast_AsRB_Player_Customization_Owner; // 0x0108(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0118(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_119[0x7];                                      // 0x0119(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRBPlayerCustomizationInfo             CallFunc_GetPlayerCustomizationInfo_ReturnValue;   // 0x0120(0x0050)()
};
static_assert(alignof(RBPlayer_BP_C_UpdateHeadCapMesh) == 0x000008, "Wrong alignment on RBPlayer_BP_C_UpdateHeadCapMesh");
static_assert(sizeof(RBPlayer_BP_C_UpdateHeadCapMesh) == 0x000170, "Wrong size on RBPlayer_BP_C_UpdateHeadCapMesh");
...
static_assert(offsetof(RBPlayer_BP_C_UpdateHeadCapMesh, Temp_bool_True_if_break_was_hit_Variable) == 0x000060, "Member 'RBPlayer_BP_C_UpdateHeadCapMesh::Temp_bool_True_if_break_was_hit_Variable' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateHeadCapMesh, CallFunc_Array_Length_ReturnValue) == 0x000064, "Member 'RBPlayer_BP_C_UpdateHeadCapMesh::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateHeadCapMesh, CallFunc_Not_PreBool_ReturnValue) == 0x000068, "Member 'RBPlayer_BP_C_UpdateHeadCapMesh::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateHeadCapMesh, Temp_int_Array_Index_Variable) == 0x00006C, "Member 'RBPlayer_BP_C_UpdateHeadCapMesh::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateHeadCapMesh, CallFunc_Array_Get_Item) == 0x000070, "Member 'RBPlayer_BP_C_UpdateHeadCapMesh::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateHeadCapMesh, CallFunc_IsValid_ReturnValue) == 0x000078, "Member 'RBPlayer_BP_C_UpdateHeadCapMesh::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateHeadCapMesh, CallFunc_BP_GetMaterialOverrideInstancesMap_ReturnValue) == 0x000080, "Member 'RBPlayer_BP_C_UpdateHeadCapMesh::CallFunc_BP_GetMaterialOverrideInstancesMap_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateHeadCapMesh, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x0000D0, "Member 'RBPlayer_BP_C_UpdateHeadCapMesh::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateHeadCapMesh, Temp_int_Loop_Counter_Variable) == 0x0000D4, "Member 'RBPlayer_BP_C_UpdateHeadCapMesh::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateHeadCapMesh, CallFunc_Less_IntInt_ReturnValue) == 0x0000D8, "Member 'RBPlayer_BP_C_UpdateHeadCapMesh::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateHeadCapMesh, CallFunc_Add_IntInt_ReturnValue) == 0x0000DC, "Member 'RBPlayer_BP_C_UpdateHeadCapMesh::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateHeadCapMesh, CallFunc_BooleanAND_ReturnValue) == 0x0000E0, "Member 'RBPlayer_BP_C_UpdateHeadCapMesh::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateHeadCapMesh, CallFunc_GetPawnCustomizationManager_ReturnValue) == 0x0000E8, "Member 'RBPlayer_BP_C_UpdateHeadCapMesh::CallFunc_GetPawnCustomizationManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateHeadCapMesh, Temp_bool_Variable) == 0x0000F0, "Member 'RBPlayer_BP_C_UpdateHeadCapMesh::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateHeadCapMesh, K2Node_Select_Default) == 0x0000F8, "Member 'RBPlayer_BP_C_UpdateHeadCapMesh::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateHeadCapMesh, CallFunc_BP_IsInFirstPerson_ReturnValue) == 0x000100, "Member 'RBPlayer_BP_C_UpdateHeadCapMesh::CallFunc_BP_IsInFirstPerson_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateHeadCapMesh, K2Node_DynamicCast_AsRB_Player_Customization_Owner) == 0x000108, "Member 'RBPlayer_BP_C_UpdateHeadCapMesh::K2Node_DynamicCast_AsRB_Player_Customization_Owner' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateHeadCapMesh, K2Node_DynamicCast_bSuccess) == 0x000118, "Member 'RBPlayer_BP_C_UpdateHeadCapMesh::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateHeadCapMesh, CallFunc_GetPlayerCustomizationInfo_ReturnValue) == 0x000120, "Member 'RBPlayer_BP_C_UpdateHeadCapMesh::CallFunc_GetPlayerCustomizationInfo_ReturnValue' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0028(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UMeshComponent*                         CallFunc_GetDisplayMesh_ReturnValue_1;             // 0x0030(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_SetStaticMesh_ReturnValue_1;              // 0x004A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_4B[0x5];                                       // 0x004B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             CallFunc_GetRelativeTransform_ReturnValue;         // 0x0050(0x0030)(IsPlainOldData, NoDestructor)
	class USkeletalMeshComponent*                 K2Node_DynamicCast_AsSkeletal_Mesh_Component;      // 0x0080(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_1;                     // 0x0088(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_89[0x3];                                       // 0x0089(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHitResult                             CallFunc_K2_SetRelativeTransform_SweepHitResult;   // 0x008C(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FHitResult                             CallFunc_K2_SetRelativeTransform_SweepHitResult_1; // 0x0114(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                          CallFunc_IsValid_ReturnValue_2;                    // 0x019C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsValid_ReturnValue_3;                    // 0x019D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(RBPlayer_BP_C_UpdateShadowPickup) == 0x0001C0, "Wrong size on RBPlayer_BP_C_UpdateShadowPickup");
...
static_assert(offsetof(RBPlayer_BP_C_UpdateShadowPickup, CallFunc_IsValid_ReturnValue) == 0x000028, "Member 'RBPlayer_BP_C_UpdateShadowPickup::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateShadowPickup, CallFunc_GetDisplayMesh_ReturnValue_1) == 0x000030, "Member 'RBPlayer_BP_C_UpdateShadowPickup::CallFunc_GetDisplayMesh_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateShadowPickup, CallFunc_IsValid_ReturnValue_1) == 0x000038, "Member 'RBPlayer_BP_C_UpdateShadowPickup::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateShadowPickup, K2Node_DynamicCast_AsStatic_Mesh_Component) == 0x000040, "Member 'RBPlayer_BP_C_UpdateShadowPickup::K2Node_DynamicCast_AsStatic_Mesh_Component' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateShadowPickup, K2Node_DynamicCast_bSuccess) == 0x000048, "Member 'RBPlayer_BP_C_UpdateShadowPickup::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateShadowPickup, CallFunc_SetStaticMesh_ReturnValue) == 0x000049, "Member 'RBPlayer_BP_C_UpdateShadowPickup::CallFunc_SetStaticMesh_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateShadowPickup, CallFunc_SetStaticMesh_ReturnValue_1) == 0x00004A, "Member 'RBPlayer_BP_C_UpdateShadowPickup::CallFunc_SetStaticMesh_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateShadowPickup, CallFunc_GetRelativeTransform_ReturnValue) == 0x000050, "Member 'RBPlayer_BP_C_UpdateShadowPickup::CallFunc_GetRelativeTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateShadowPickup, K2Node_DynamicCast_AsSkeletal_Mesh_Component) == 0x000080, "Member 'RBPlayer_BP_C_UpdateShadowPickup::K2Node_DynamicCast_AsSkeletal_Mesh_Component' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateShadowPickup, K2Node_DynamicCast_bSuccess_1) == 0x000088, "Member 'RBPlayer_BP_C_UpdateShadowPickup::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateShadowPickup, CallFunc_K2_SetRelativeTransform_SweepHitResult) == 0x00008C, "Member 'RBPlayer_BP_C_UpdateShadowPickup::CallFunc_K2_SetRelativeTransform_SweepHitResult' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateShadowPickup, CallFunc_K2_SetRelativeTransform_SweepHitResult_1) == 0x000114, "Member 'RBPlayer_BP_C_UpdateShadowPickup::CallFunc_K2_SetRelativeTransform_SweepHitResult_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateShadowPickup, CallFunc_IsValid_ReturnValue_2) == 0x00019C, "Member 'RBPlayer_BP_C_UpdateShadowPickup::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateShadowPickup, CallFunc_IsValid_ReturnValue_3) == 0x00019D, "Member 'RBPlayer_BP_C_UpdateShadowPickup::CallFunc_IsValid_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateShadowPickup, K2Node_MakeStruct_SingleAnimationPlayData) == 0x0001A0, "Member 'RBPlayer_BP_C_UpdateShadowPickup::K2Node_MakeStruct_SingleAnimationPlayData' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_UpdateShadowPickup, CallFunc_IsValid_ReturnValue_4) == 0x0001B8, "Member 'RBPlayer_BP_C_UpdateShadowPickup::CallFunc_IsValid_ReturnValue_4' has a wrong offset!");
...
// 0x0008 (0x0008 - 0x0000)
struct RBPlayer_BP_C_OnRep_bAIDisturbanceItemActive final
{
public:
	bool                                          CallFunc_IsDedicatedServer_ReturnValue;            // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(alignof(RBPlayer_BP_C_OnRep_bAIDisturbanceItemActive) == 0x000004, "Wrong alignment on RBPlayer_BP_C_OnRep_bAIDisturbanceItemActive");
static_assert(sizeof(RBPlayer_BP_C_OnRep_bAIDisturbanceItemActive) == 0x000008, "Wrong size on RBPlayer_BP_C_OnRep_bAIDisturbanceItemActive");
static_assert(offsetof(RBPlayer_BP_C_OnRep_bAIDisturbanceItemActive, CallFunc_IsDedicatedServer_ReturnValue) == 0x000000, "Member 'RBPlayer_BP_C_OnRep_bAIDisturbanceItemActive::CallFunc_IsDedicatedServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_OnRep_bAIDisturbanceItemActive, CallFunc_PlayLoopingSoundOnActor_ReturnValue) == 0x000004, "Member 'RBPlayer_BP_C_OnRep_bAIDisturbanceItemActive::CallFunc_PlayLoopingSoundOnActor_ReturnValue' has a wrong offset!");
...
public:
	...
	class ARBPlayerState*                         CallFunc_GetPlayerStateByPlayer_ReturnValue;       // 0x0050(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class URBPlayerCustomizationConfig*           CallFunc_GetPlayerCustomizationConfig_ReturnValue; // 0x0058(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsValid_ReturnValue_1;                    // 0x0061(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_62[0x6];                                       // 0x0062(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRBPlayerCustomizationInfo             CallFunc_GetCustomizationInfo_ReturnValue;         // 0x0068(0x0050)(ConstParm)
};
...
static_assert(sizeof(RBPlayer_BP_C_GetPlayerCustomizationInfo) == 0x0000B8, "Wrong size on RBPlayer_BP_C_GetPlayerCustomizationInfo");
...
static_assert(offsetof(RBPlayer_BP_C_GetPlayerCustomizationInfo, CallFunc_GetPlayerStateByPlayer_ReturnValue) == 0x000050, "Member 'RBPlayer_BP_C_GetPlayerCustomizationInfo::CallFunc_GetPlayerStateByPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_GetPlayerCustomizationInfo, CallFunc_GetPlayerCustomizationConfig_ReturnValue) == 0x000058, "Member 'RBPlayer_BP_C_GetPlayerCustomizationInfo::CallFunc_GetPlayerCustomizationConfig_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_GetPlayerCustomizationInfo, CallFunc_IsValid_ReturnValue) == 0x000060, "Member 'RBPlayer_BP_C_GetPlayerCustomizationInfo::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_GetPlayerCustomizationInfo, CallFunc_IsValid_ReturnValue_1) == 0x000061, "Member 'RBPlayer_BP_C_GetPlayerCustomizationInfo::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_GetPlayerCustomizationInfo, CallFunc_GetCustomizationInfo_ReturnValue) == 0x000068, "Member 'RBPlayer_BP_C_GetPlayerCustomizationInfo::CallFunc_GetCustomizationInfo_ReturnValue' has a wrong offset!");
...
struct RBPlayer_BP_C_GetShadowSkeletalMeshComponentForSlot final
{
public:
	EPlayerCustomizationSlot                      Slot;                                              // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_2[0x6];                                        // 0x0002(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class USkeletalMeshComponent*                 ReturnValue;                                       // 0x0008(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class USkeletalMeshComponent*                 CallFunc_GetSkeletalMeshComponentForSlot_ReturnValue; // 0x0010(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class USkeletalMeshComponent*                 CallFunc_Map_Find_Value;                           // 0x0018(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Map_Find_ReturnValue;                     // 0x0020(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(RBPlayer_BP_C_GetShadowSkeletalMeshComponentForSlot) == 0x000008, "Wrong alignment on RBPlayer_BP_C_GetShadowSkeletalMeshComponentForSlot");
static_assert(sizeof(RBPlayer_BP_C_GetShadowSkeletalMeshComponentForSlot) == 0x000028, "Wrong size on RBPlayer_BP_C_GetShadowSkeletalMeshComponentForSlot");
static_assert(offsetof(RBPlayer_BP_C_GetShadowSkeletalMeshComponentForSlot, Slot) == 0x000000, "Member 'RBPlayer_BP_C_GetShadowSkeletalMeshComponentForSlot::Slot' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_GetShadowSkeletalMeshComponentForSlot, OutFound) == 0x000001, "Member 'RBPlayer_BP_C_GetShadowSkeletalMeshComponentForSlot::OutFound' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_GetShadowSkeletalMeshComponentForSlot, ReturnValue) == 0x000008, "Member 'RBPlayer_BP_C_GetShadowSkeletalMeshComponentForSlot::ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_GetShadowSkeletalMeshComponentForSlot, CallFunc_GetSkeletalMeshComponentForSlot_ReturnValue) == 0x000010, "Member 'RBPlayer_BP_C_GetShadowSkeletalMeshComponentForSlot::CallFunc_GetSkeletalMeshComponentForSlot_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_GetShadowSkeletalMeshComponentForSlot, CallFunc_Map_Find_Value) == 0x000018, "Member 'RBPlayer_BP_C_GetShadowSkeletalMeshComponentForSlot::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(RBPlayer_BP_C_GetShadowSkeletalMeshComponentForSlot, CallFunc_Map_Find_ReturnValue) == 0x000020, "Member 'RBPlayer_BP_C_GetShadowSkeletalMeshComponentForSlot::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
