...
class UWidget* UTasksWidget_C::NavToFirstTask(EUINavigation Navigation_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TasksWidget_C", "NavToFirstTask");

	Params::TasksWidget_C_NavToFirstTask Parms{};
