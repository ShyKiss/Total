...
public:
	...
	class UStaticMeshComponent*                   GasCanisterMesh;                                   // 0x0A70(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABase_NonPickable_RBPickup_BP_C) == 0x000A80, "Wrong size on ABase_NonPickable_RBPickup_BP_C");
static_assert(offsetof(ABase_NonPickable_RBPickup_BP_C, GasCanisterMesh) == 0x000A70, "Member 'ABase_NonPickable_RBPickup_BP_C::GasCanisterMesh' has a wrong offset!");
