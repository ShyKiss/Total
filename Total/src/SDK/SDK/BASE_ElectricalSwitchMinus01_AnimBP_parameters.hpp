...
static_assert(offsetof(BASE_ElectricalSwitchMinus01_AnimBP_C_AnimGraph, AnimGraph_0) == 0x000000, "Member 'BASE_ElectricalSwitchMinus01_AnimBP_C_AnimGraph::AnimGraph_0' has a wrong offset!");
