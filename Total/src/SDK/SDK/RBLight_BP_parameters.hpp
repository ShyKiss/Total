...
struct RBLight_BP_C_SetAudioOverrides final
{
public:
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FInteractionSoundEvent                 K2Node_MakeStruct_InteractionSoundEvent;           // 0x0008(0x0020)(NoDestructor)
	bool                                          CallFunc_IsValid_ReturnValue_1;                    // 0x0028(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FInteractionSoundEvent                 K2Node_MakeStruct_InteractionSoundEvent_1;         // 0x0030(0x0020)(NoDestructor)
};
static_assert(alignof(RBLight_BP_C_SetAudioOverrides) == 0x000008, "Wrong alignment on RBLight_BP_C_SetAudioOverrides");
static_assert(sizeof(RBLight_BP_C_SetAudioOverrides) == 0x000050, "Wrong size on RBLight_BP_C_SetAudioOverrides");
static_assert(offsetof(RBLight_BP_C_SetAudioOverrides, CallFunc_IsValid_ReturnValue) == 0x000000, "Member 'RBLight_BP_C_SetAudioOverrides::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBLight_BP_C_SetAudioOverrides, K2Node_MakeStruct_InteractionSoundEvent) == 0x000008, "Member 'RBLight_BP_C_SetAudioOverrides::K2Node_MakeStruct_InteractionSoundEvent' has a wrong offset!");
static_assert(offsetof(RBLight_BP_C_SetAudioOverrides, CallFunc_IsValid_ReturnValue_1) == 0x000028, "Member 'RBLight_BP_C_SetAudioOverrides::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBLight_BP_C_SetAudioOverrides, K2Node_MakeStruct_InteractionSoundEvent_1) == 0x000030, "Member 'RBLight_BP_C_SetAudioOverrides::K2Node_MakeStruct_InteractionSoundEvent_1' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_IsDedicatedServer_ReturnValue;            // 0x008E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(RBLight_BP_C_SetDustParticle, CallFunc_IsValid_ReturnValue) == 0x00008C, "Member 'RBLight_BP_C_SetDustParticle::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(RBLight_BP_C_SetDustParticle, CallFunc_IsValid_ReturnValue_1) == 0x00008D, "Member 'RBLight_BP_C_SetDustParticle::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RBLight_BP_C_SetDustParticle, CallFunc_IsDedicatedServer_ReturnValue) == 0x00008E, "Member 'RBLight_BP_C_SetDustParticle::CallFunc_IsDedicatedServer_ReturnValue' has a wrong offset!");
...
// 0x0001 (0x0001 - 0x0000)
struct RBLight_BP_C_IsRandomStateSet final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor)
};
static_assert(alignof(RBLight_BP_C_IsRandomStateSet) == 0x000001, "Wrong alignment on RBLight_BP_C_IsRandomStateSet");
static_assert(sizeof(RBLight_BP_C_IsRandomStateSet) == 0x000001, "Wrong size on RBLight_BP_C_IsRandomStateSet");
static_assert(offsetof(RBLight_BP_C_IsRandomStateSet, ReturnValue) == 0x000000, "Member 'RBLight_BP_C_IsRandomStateSet::ReturnValue' has a wrong offset!");
