...
public:
	...
	bool                                          CallFunc_ShouldAimWeapon_AimWeapon;                // 0x0041(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP) == 0x000060, "Wrong size on Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP");
...
static_assert(offsetof(Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP, CallFunc_TryGetPawnOwner_ReturnValue) == 0x000030, "Member 'Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP::CallFunc_TryGetPawnOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP, K2Node_DynamicCast_AsRB_NPC) == 0x000038, "Member 'Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP::K2Node_DynamicCast_AsRB_NPC' has a wrong offset!");
static_assert(offsetof(Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP, K2Node_DynamicCast_bSuccess) == 0x000040, "Member 'Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP, CallFunc_ShouldAimWeapon_AimWeapon) == 0x000041, "Member 'Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP::CallFunc_ShouldAimWeapon_AimWeapon' has a wrong offset!");
static_assert(offsetof(Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP, CallFunc_IsValid_ReturnValue) == 0x000042, "Member 'Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP, CallFunc_Conv_BoolToFloat_ReturnValue) == 0x000044, "Member 'Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP::CallFunc_Conv_BoolToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP, CallFunc_GetWorldDeltaSeconds_ReturnValue) == 0x000048, "Member 'Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP::CallFunc_GetWorldDeltaSeconds_ReturnValue' has a wrong offset!");
static_assert(offsetof(Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x00004C, "Member 'Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP, CallFunc_FInterpTo_ReturnValue) == 0x000050, "Member 'Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP::CallFunc_FInterpTo_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP, CallFunc_FInterpTo_ReturnValue_1) == 0x000058, "Member 'Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP::CallFunc_FInterpTo_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP, CallFunc_Multiply_FloatFloat_ReturnValue_1) == 0x00005C, "Member 'Grunt_AnimBP_C_ExecuteUbergraph_grunt_AnimBP::CallFunc_Multiply_FloatFloat_ReturnValue_1' has a wrong offset!");
...
static_assert(sizeof(Grunt_AnimBP_C_Update_Right_Hand_Pose_Override) == 0x00001C, "Wrong size on Grunt_AnimBP_C_Update_Right_Hand_Pose_Override");
...
static_assert(offsetof(Grunt_AnimBP_C_Update_Right_Hand_Pose_Override, CallFunc_SelectFloat_ReturnValue) == 0x000014, "Member 'Grunt_AnimBP_C_Update_Right_Hand_Pose_Override::CallFunc_SelectFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Grunt_AnimBP_C_Update_Right_Hand_Pose_Override, CallFunc_FInterpTo_ReturnValue) == 0x000018, "Member 'Grunt_AnimBP_C_Update_Right_Hand_Pose_Override::CallFunc_FInterpTo_ReturnValue' has a wrong offset!");
