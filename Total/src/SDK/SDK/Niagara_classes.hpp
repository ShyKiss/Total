...
public:
	...
	uint8                                         BitPad_558_2 : 6;                                  // 0x0558(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
	uint8                                         Pad_559[0x2F];                                     // 0x0559(0x002F)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5CB[0x65];                                     // 0x05CB(0x0065)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	struct FNiagaraVariableAttributeBinding       VolumetricsIntensityBinding;                       // 0x0250(0x0058)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       SourceRadiusBinding;                               // 0x02A8(0x0058)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       SoftSourceRadiusBinding;                           // 0x0300(0x0058)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       SpecularScaleBinding;                              // 0x0358(0x0058)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RendererVisibilityTagBinding;                      // 0x03B0(0x0058)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraLightRendererProperties) == 0x000450, "Wrong size on UNiagaraLightRendererProperties");
...
static_assert(offsetof(UNiagaraLightRendererProperties, VolumetricsIntensityBinding) == 0x000250, "Member 'UNiagaraLightRendererProperties::VolumetricsIntensityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, SourceRadiusBinding) == 0x0002A8, "Member 'UNiagaraLightRendererProperties::SourceRadiusBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, SoftSourceRadiusBinding) == 0x000300, "Member 'UNiagaraLightRendererProperties::SoftSourceRadiusBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, SpecularScaleBinding) == 0x000358, "Member 'UNiagaraLightRendererProperties::SpecularScaleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, RendererVisibilityTagBinding) == 0x0003B0, "Member 'UNiagaraLightRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
