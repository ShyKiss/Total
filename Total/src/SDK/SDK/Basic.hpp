...
namespace Offsets
{
	constexpr int32 GObjects          = 0x05D8E260;
	constexpr int32 AppendString      = 0x009F56AC;
	constexpr int32 GNames            = 0x05F13840;
	constexpr int32 GWorld            = 0x05DDD510;
	constexpr int32 ProcessEvent      = 0x00791DC4;
