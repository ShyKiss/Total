...
void UProgramTrialRewardWidget_C::InitFromRewardUIData(bool Param_bAcquired, bool bPerfect, const struct FRewardUIData& RewardUIData)
{
	static class UFunction* Func = nullptr;
...
// class FText                             Param_ForcedText                                       (BlueprintVisible, BlueprintReadOnly, Parm)

void UProgramTrialRewardWidget_C::Init(bool Param_bAcquired, bool bPerfect, int32 Param_Amount, class UTexture2D* Param_IconTexture, const struct FSlateColor& IconColor, const class FText& Param_ForcedText)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_ForcedText = std::move(Param_ForcedText);
