...
// struct FRBPlayerBadgeRow                Param_BadgeSettings                                    (BlueprintVisible, BlueprintReadOnly, Parm)
// bool                                    bInClaimable                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UBadgeSashEntry_C::Setup(int32 Param_UnlockedCount, const struct FRBPlayerBadgeRow& Param_BadgeSettings, bool bInClaimable)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_BadgeSettings = std::move(Param_BadgeSettings);
	Parms.bInClaimable = bInClaimable;
