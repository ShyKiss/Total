...
void URigButton_C::ComputeTier()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("RigButton_C", "ComputeTier");
...
// bool                                    Param_bIsHeader                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void URigButton_C::Init(bool Param_bIsLoadout, class FName ItemId, bool Param_bIsHeader)
{
	static class UFunction* Func = nullptr;
	...
	Parms.ItemId = ItemId;
	Parms.Param_bIsHeader = Param_bIsHeader;
