...
public:
	...
	uint8                                         Pad_3270[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	ECollisionEnabled                             CallFunc_GetCollisionEnabled_ReturnValue;          // 0x002C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(CellCustomizationBundleBase_C_UserConstructionScript) == 0x000030, "Wrong size on CellCustomizationBundleBase_C_UserConstructionScript");
...
static_assert(offsetof(CellCustomizationBundleBase_C_UserConstructionScript, CallFunc_GetCollisionEnabled_ReturnValue) == 0x00002C, "Member 'CellCustomizationBundleBase_C_UserConstructionScript::CallFunc_GetCollisionEnabled_ReturnValue' has a wrong offset!");
static_assert(offsetof(CellCustomizationBundleBase_C_UserConstructionScript, CallFunc_Less_IntInt_ReturnValue) == 0x00002D, "Member 'CellCustomizationBundleBase_C_UserConstructionScript::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(CellCustomizationBundleBase_C_UserConstructionScript, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x00002E, "Member 'CellCustomizationBundleBase_C_UserConstructionScript::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(CellCustomizationBundleBase_C_UserConstructionScript, CallFunc_Not_PreBool_ReturnValue) == 0x00002F, "Member 'CellCustomizationBundleBase_C_UserConstructionScript::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
