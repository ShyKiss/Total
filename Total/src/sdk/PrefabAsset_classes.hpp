...
static_assert(sizeof(UPrefabAsset) == 0x000028, "Wrong size on UPrefabAsset");
...
static_assert(sizeof(UPrefabVariantAsset) == 0x000030, "Wrong size on UPrefabVariantAsset");
...
static_assert(offsetof(UPrefabToolSettings, bTryQuickApplyFirstWhenApply) == 0x000049, "Member 'UPrefabToolSettings::bTryQuickApplyFirstWhenApply' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bAutoAddRemoveVariantActorPrefix) == 0x00004A, "Member 'UPrefabToolSettings::bAutoAddRemoveVariantActorPrefix' has a wrong offset!");
...
static_assert(offsetof(UPrefabToolSettings, bSkipActorReferenceReplacement) == 0x0000FD, "Member 'UPrefabToolSettings::bSkipActorReferenceReplacement' has a wrong offset!");
