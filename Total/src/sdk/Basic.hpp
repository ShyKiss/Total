...
namespace Offsets
{
	constexpr int32 GObjects          = 0x05C33880;
	constexpr int32 AppendString      = 0x00916BEC;
	constexpr int32 GNames            = 0x05DAD9C0;
	constexpr int32 GWorld            = 0x05C83430;
	constexpr int32 ProcessEvent      = 0x008C8264;
