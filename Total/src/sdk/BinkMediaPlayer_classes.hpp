...
{
public:
	uint8                                         Pad_1152[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	FMulticastInlineDelegateProperty_             OnMediaLooped;                                     // 0x0060(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPlaybackSuspended;                               // 0x0070(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         OnlyVisibleWhenPlaying : 1;                        // 0x0080(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         OptimizedSeek : 1;                                 // 0x0080(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1153[0x3];                                     // 0x0081(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1154[0x4];                                     // 0x0094(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1155[0x2];                                     // 0x00AA(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         BinkSoundTrackStart;                               // 0x00AC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_1156[0x3];                                     // 0x00B1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1157[0x98];                                    // 0x00B8(0x0098)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UBinkMediaPlayer, OnMediaLooped) == 0x000060, "Member 'UBinkMediaPlayer::OnMediaLooped' has a wrong offset!");
static_assert(offsetof(UBinkMediaPlayer, OnPlaybackSuspended) == 0x000070, "Member 'UBinkMediaPlayer::OnPlaybackSuspended' has a wrong offset!");
static_assert(offsetof(UBinkMediaPlayer, BinkDestinationUpperLeft) == 0x000084, "Member 'UBinkMediaPlayer::BinkDestinationUpperLeft' has a wrong offset!");
static_assert(offsetof(UBinkMediaPlayer, BinkDestinationLowerRight) == 0x00008C, "Member 'UBinkMediaPlayer::BinkDestinationLowerRight' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_115E[0x6];                                     // 0x0172(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_115F[0x2];                                     // 0x0182(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1160[0x23];                                    // 0x018D(0x0023)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UBinkMediaTexture, AddressX) == 0x000170, "Member 'UBinkMediaTexture::AddressX' has a wrong offset!");
static_assert(offsetof(UBinkMediaTexture, AddressY) == 0x000171, "Member 'UBinkMediaTexture::AddressY' has a wrong offset!");
static_assert(offsetof(UBinkMediaTexture, MediaPlayer) == 0x000178, "Member 'UBinkMediaTexture::MediaPlayer' has a wrong offset!");
static_assert(offsetof(UBinkMediaTexture, PixelFormat) == 0x000180, "Member 'UBinkMediaTexture::PixelFormat' has a wrong offset!");
static_assert(offsetof(UBinkMediaTexture, Tonemap) == 0x000181, "Member 'UBinkMediaTexture::Tonemap' has a wrong offset!");
static_assert(offsetof(UBinkMediaTexture, OutputNits) == 0x000184, "Member 'UBinkMediaTexture::OutputNits' has a wrong offset!");
static_assert(offsetof(UBinkMediaTexture, Alpha) == 0x000188, "Member 'UBinkMediaTexture::Alpha' has a wrong offset!");
static_assert(offsetof(UBinkMediaTexture, DecodeSRGB) == 0x00018C, "Member 'UBinkMediaTexture::DecodeSRGB' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1161[0x2];                                     // 0x002A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1162[0x7];                                     // 0x0041(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
