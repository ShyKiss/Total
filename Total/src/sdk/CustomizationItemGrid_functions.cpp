...
class UWidget* UCustomizationItemGrid_C::GamepadNav_HandleGridNavigation(EUINavigation Param_Navigation)
{
	static class UFunction* Func = nullptr;
...
void UCustomizationItemGrid_C::AddItems(TArray<struct FUICustomizationItem>& Items, ECustomizationMenuCategory Param_Category)
{
	static class UFunction* Func = nullptr;
...
void UCustomizationItemGrid_C::GetLastEmptyItemIndex(int32* Param_Index)
{
	static class UFunction* Func = nullptr;
