...
{
public:
	uint8                                         Pad_125B[0x8];                                     // 0x0880(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_125C[0x2C];                                    // 0x0894(0x002C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAudioCurveSourceComponent) == 0x0008C0, "Wrong size on UAudioCurveSourceComponent");
static_assert(offsetof(UAudioCurveSourceComponent, CurveSourceBindingName) == 0x000888, "Member 'UAudioCurveSourceComponent::CurveSourceBindingName' has a wrong offset!");
static_assert(offsetof(UAudioCurveSourceComponent, CurveSyncOffset) == 0x000890, "Member 'UAudioCurveSourceComponent::CurveSyncOffset' has a wrong offset!");
