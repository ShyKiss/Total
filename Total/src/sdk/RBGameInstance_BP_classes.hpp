...
static_assert(sizeof(URBGameInstance_BP_C) == 0x000418, "Wrong size on URBGameInstance_BP_C");
static_assert(offsetof(URBGameInstance_BP_C, UberGraphFrame) == 0x000410, "Member 'URBGameInstance_BP_C::UberGraphFrame' has a wrong offset!");
