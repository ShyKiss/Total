...
public:
	...
	uint8                                         Pad_314E[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_314F[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(Cine_Futterman_AnimBP_C_ExecuteUbergraph_Cine_Futterman_AnimBP) == 0x000030, "Wrong size on Cine_Futterman_AnimBP_C_ExecuteUbergraph_Cine_Futterman_AnimBP");
...
static_assert(offsetof(Cine_Futterman_AnimBP_C_ExecuteUbergraph_Cine_Futterman_AnimBP, CallFunc_GetOwningComponent_ReturnValue) == 0x000008, "Member 'Cine_Futterman_AnimBP_C_ExecuteUbergraph_Cine_Futterman_AnimBP::CallFunc_GetOwningComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(Cine_Futterman_AnimBP_C_ExecuteUbergraph_Cine_Futterman_AnimBP, CallFunc_GetOwningActor_ReturnValue) == 0x000010, "Member 'Cine_Futterman_AnimBP_C_ExecuteUbergraph_Cine_Futterman_AnimBP::CallFunc_GetOwningActor_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Cine_Futterman_AnimBP_C_AnimGraph, Param_AnimGraph) == 0x000000, "Member 'Cine_Futterman_AnimBP_C_AnimGraph::Param_AnimGraph' has a wrong offset!");
