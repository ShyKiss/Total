...
public:
	...
	uint8                                         Pad_2E6E[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(TasksMenu_C_Event_OnUnfocusMenu) == 0x000001, "Wrong alignment on TasksMenu_C_Event_OnUnfocusMenu");
static_assert(sizeof(TasksMenu_C_Event_OnUnfocusMenu) == 0x000001, "Wrong size on TasksMenu_C_Event_OnUnfocusMenu");
