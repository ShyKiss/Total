...
void AMenuCharacter_C::CycleCameras(ECustomizationMenuCategory Selection)
{
	static class UFunction* Func = nullptr;
...
void AMenuCharacter_C::GetFacePoseAsset(class UPoseAsset** Param_FacePoseAsset)
{
	static class UFunction* Func = nullptr;
...
void AMenuCharacter_C::SetDebugMode(bool Param_Debug)
{
	static class UFunction* Func = nullptr;
...
void AMenuCharacter_C::CustomEvent_0(ECustomizationMenuCategory CustomizationMenuCategory)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MenuCharacter_C", "CustomEvent_0");

	Params::MenuCharacter_C_CustomEvent_0 Parms{};
...
void AMenuCharacter_C::OnCustomizationLoaded(class AActor* CustomizationOwner, int32 RequestID, EPawnCustomizationRequestType RequestType)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MenuCharacter_C", "OnCustomizationLoaded");

	Params::MenuCharacter_C_OnCustomizationLoaded Parms{};
...
void AMenuCharacter_C::OnCurrentLoadoutChanged()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("MenuCharacter_C", "OnCurrentLoadoutChanged");
...
void AMenuCharacter_C::OnCustomizationLoadedEvent__DelegateSignature()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("MenuCharacter_C", "OnCustomizationLoadedEvent__DelegateSignature");
