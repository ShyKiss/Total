...
public:
	...
	class UTextBlock*                             ChainingCount;                                     // 0x0308(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(offsetof(UHUDStageIntro_C, ChainingCount) == 0x000308, "Member 'UHUDStageIntro_C::ChainingCount' has a wrong offset!");
