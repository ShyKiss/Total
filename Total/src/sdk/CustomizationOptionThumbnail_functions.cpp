...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    Param_IsEmpty                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UCustomizationOptionThumbnail_C::UpdateThumbnailType(bool Param_IsEmpty)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_IsEmpty = Param_IsEmpty;
...
struct FEventReply UCustomizationOptionThumbnail_C::OnMouseButtonDown(const struct FGeometry& MyGeometry, const struct FPointerEvent& MouseEvent)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("CustomizationOptionThumbnail_C", "OnMouseButtonDown");

	Params::CustomizationOptionThumbnail_C_OnMouseButtonDown Parms{};
...
void UCustomizationOptionThumbnail_C::SetHovered(bool Param_IsHovered)
{
	static class UFunction* Func = nullptr;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FUICustomizationItem             Param_Item                                             (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
// int32                                   Param_Index                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// ECustomizationMenuCategory              Param_Category                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UCustomizationOptionThumbnail_C::Initialize(const struct FUICustomizationItem& Param_Item, int32 Param_Index, ECustomizationMenuCategory Param_Category)
{
	static class UFunction* Func = nullptr;
