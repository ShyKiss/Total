...
class FString UFileMediaSource::GetMediaSourceFilePath(class UMediaSource* MediaSource)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("FileMediaSource", "GetMediaSourceFilePath");

	Params::FileMediaSource_GetMediaSourceFilePath Parms{};
