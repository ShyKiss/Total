...
public:
	...
	class UNiagaraComponent*                      Ngr_SkillDeactivate;                               // 0x0BF8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UMaterialInstance*                      PostProcess;                                       // 0x0C00(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABaseAmp_SkillItem_BP_C) == 0x000C10, "Wrong size on ABaseAmp_SkillItem_BP_C");
static_assert(offsetof(ABaseAmp_SkillItem_BP_C, UberGraphFrame) == 0x000BF0, "Member 'ABaseAmp_SkillItem_BP_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABaseAmp_SkillItem_BP_C, Ngr_SkillDeactivate) == 0x000BF8, "Member 'ABaseAmp_SkillItem_BP_C::Ngr_SkillDeactivate' has a wrong offset!");
static_assert(offsetof(ABaseAmp_SkillItem_BP_C, PostProcess) == 0x000C00, "Member 'ABaseAmp_SkillItem_BP_C::PostProcess' has a wrong offset!");
