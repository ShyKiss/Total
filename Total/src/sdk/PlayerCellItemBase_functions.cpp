...
void APlayerCellItemBase_C::PreviewBlueprintClass_Editor(TSoftClassPtr<class UClass> Param_Class, class URBPlayerCellItemDefinition* CellItemDefinition)
{
	static class UFunction* Func = nullptr;
...
void APlayerCellItemBase_C::PreviewItem(class URBPlayerCellItemDefinition* Target)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("PlayerCellItemBase_C", "PreviewItem");

	Params::PlayerCellItemBase_C_PreviewItem Parms{};
